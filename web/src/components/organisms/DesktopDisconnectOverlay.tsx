  ...
  return (
    ...
    >
      <div className="flex max-w-md flex-col items-center rounded-3xl border border-border bg-background-secondary p-8 text-center shadow-2xl">
        <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-state-error/10 text-4xl">
          ⚠️
        </div>
        ...
        <button
          ...
          onClick={onRestart}
          disabled={restarting}
          className="mt-6 rounded-lg bg-accent-primary px-6 py-2.5 text-sm font-medium text-text-on-accent hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-60 transition-colors"
        >
