...
const THEMES: Record<ChatMode, ModeTheme> = {
  chat: {
    ...
    tabActive: 'bg-brand-turquesa/25 text-brand-turquesa shadow-sm',
  ...
  agent: {
    ...
    tabActive: 'bg-brand-morado/25 text-brand-morado shadow-sm',
  ...
  group: {
    ...
    tabActive: 'bg-brand-naranja/25 text-brand-naranja shadow-sm',
